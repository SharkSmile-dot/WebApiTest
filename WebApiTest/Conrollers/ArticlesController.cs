...
namespace WebApiTest.Conrollers
{
    ...
    public class ArticlesController : ControllerBase
    {
        ...
        /// <summary>
        /// Добавление статьи !не указывайте id при добавлении! Максимальная вложенность 2! 
        /// </summary>
        ...
        /// <summary>
        /// Изменение статьи !id обязателен чтобы найти запись! Максимальная вложенность 2! 
        /// </summary>
