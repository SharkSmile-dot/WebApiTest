...
namespace WebApiTest.Conrollers
{
    ...
    public class OperationsController : ControllerBase
    {
        ...
        /// <summary>
        /// Добавление операции !не указывайте id при добавлении! Контрагент и статья добавляются в формате "CR_int","AR_int"!!! 
        /// </summary>
        ...
        /// <summary>
        /// Изменение операции !id обязателен чтобы найти запись! Контрагент и статья изменяются в формате "CR_int","AR_int"!!!
        /// </summary>
