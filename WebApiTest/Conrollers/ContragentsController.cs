...
namespace WebApiTest.Conrollers
{
    ...
    public class ContragentsController : ControllerBase
    {
        ...
        /// <summary>
        /// Добавление контрагента !не указывайте id при добавлении! Контрагент и статья добавляются в формате "CR_int","AR_int"!!! 
        /// </summary>
        ...
        /// <summary>
        /// Изменение контрагента !id обязателен чтобы найти запись! Контрагент и статья изменяются в формате "CR_int","AR_int"!!! 
        /// </summary>
